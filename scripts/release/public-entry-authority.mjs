const EXPECTED = Object.freeze([
  Object.freeze({ package: "@pixel-point/aval-graph", export: ".", path: "dist/index.js" }),
  Object.freeze({ package: "@pixel-point/aval-format", export: ".", path: "dist/index.js" }),
  Object.freeze({ package: "@pixel-point/aval-player-web", export: ".", path: "dist/index.js" }),
  Object.freeze({ package: "@pixel-point/aval-element", export: ".", path: "dist/index.js" }),
  Object.freeze({ package: "@pixel-point/aval-element", export: "./auto", path: "dist/auto.js" })
]);
